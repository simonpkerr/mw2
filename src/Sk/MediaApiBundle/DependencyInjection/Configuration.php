                            ...
                            ->arrayNode('wikimedia_provider')->isRequired()
                                ->children()
                                    ->arrayNode('access_params')->isRequired()
                                        ...
                                        ->end()
                                    ->end()
                                    ->arrayNode('simple_request')
                                    ->addDefaultsIfNotSet()
                                        ->children()
                                            ->scalarNode('class')->defaultValue('Sk\MediaApiBundle\MediaProviderApi\SimpleRequest')->end()
                                        ->end()
                                    ->end()//end of wikimedia_request
                                ->end()
                            ->end()//end of wikimedia provider
                            ->arrayNode('seven_digital_provider')->isRequired()
                                ->children()
                                    ->arrayNode('access_params')->isRequired()
                                        ->children()
                                            ->arrayNode('seven_digital_endpoints')->isRequired()
                                                ->children()
                                                    ->scalarNode('query_endpoint')->isRequired()->cannotBeEmpty()->end()
                                                    ->scalarNode('streaming_endpoint')->isRequired()->cannotBeEmpty()->end()
                                                ->end()
                                            ->end()
                                            ->scalarNode('seven_digital_oauth_key')->isRequired()->cannotBeEmpty()->end()
                                        ->end()
                                    ->end()
                                    ->arrayNode('simple_request')
                                    ->addDefaultsIfNotSet()
                                        ->children()
                                            ->scalarNode('class')->defaultValue('Sk\MediaApiBundle\MediaProviderApi\SimpleRequest')->end()
                                        ->end()
                                    ->end()//end of simple_request
                                ->end()
                            ->end()//end of seven_digital provider
                        ->end()
